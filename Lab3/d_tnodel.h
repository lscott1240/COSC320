...
tnode<int> * buildIntTree(int n)
{
	...
	switch(n)
	{
		...
		case 0:
			d = new tnode<int> (12);
			e = new tnode<int> (6);
			b = new tnode<int> (3,(tnode<int> *)NULL, d);
			c = new tnode<int> (40,e, (tnode<int> *)NULL);
			root = new tnode<int> (24,b, c);
			break;
		...
		case 1:
			...
			i = new tnode<int> (18);
			d = new tnode<int> (12);
			e = new tnode<int> (6,g, (tnode<int> *)NULL);
			f = new tnode<int> (1,h, i);
			b = new tnode<int> (3,d, e);
			c = new tnode<int> (7,(tnode<int> *)NULL, f);
			root = new tnode<int> (24,b, c);
			break;
		...
		case 2:
			...
			h = new tnode<int> (6);
			i = new tnode<int> (4);
			d = new tnode<int> (8,(tnode<int> *)NULL, g);
			e = new tnode<int> (13,h, i);
			f = new tnode<int> (33);
			b = new tnode<int> (11,d, (tnode<int> *)NULL);
			c = new tnode<int> (2,e, f);
			root = new tnode<int> (7,b, c);
			break;
		case 3:
			f = new tnode<int> (12);
			d = new tnode<int> (5);
